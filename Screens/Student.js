...
const Student = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable style={styles.saveButton} onPress={handleReturn} disabled={isSaving}>
        {isSaving ? (
      ...
      <Pressable style={styles.returnButton} onPress={handleSave}>
...
const styles = {
  ...
  headerImage: {
    ...
    marginBottom: 20,
    marginTop: -25, // Adjust or set to 0 to remove the space above the image
  },
  title: {
    fontSize: 24,
    fontWeight: 'bold',
