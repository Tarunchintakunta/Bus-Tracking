...
const Admin = () => {
  ...
  const handleAddDriverPress = () => {
    navigation.navigate('AddDriver', { action: 'Add Driver' });
  };

  const handleAddStudentPress = () => {
    navigation.navigate('AddStudent', { action: 'Add Student' });
  };

  const handleCheckStatusPress = () => {
    navigation.navigate('CheckStatus'); // Navigate to CheckStatus.js
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.optionsContainer}>
        <Pressable style={styles.optionButton} onPress={handleAddDriverPress}>
          <Text style={styles.optionText}>Add a Driver</Text>
        </Pressable>
      </View>
      <View style={styles.optionsContainer}>
        <Pressable style={styles.optionButton} onPress={handleAddStudentPress}>
          <Text style={styles.optionText}>Add a Student</Text>
        </Pressable>
      </View>
      <View style={styles.optionsContainer}>
        <Pressable style={styles.optionButton} onPress={handleCheckStatusPress}>
          <Text style={styles.optionText}>Check Status</Text>
        </Pressable>
      </View>
